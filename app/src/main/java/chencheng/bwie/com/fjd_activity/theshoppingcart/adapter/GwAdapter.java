package chencheng.bwie.com.fjd_activity.theshoppingcart.adapter;
...
public class GwAdapter extends BaseExpandableListAdapter {
    ...
    public GwAdapter(Context context, List<CartsBean.DataBean> groupList, List<List<CartsBean.DataBean.ListBean>> childList) {
